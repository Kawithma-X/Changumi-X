...
module.exports = {
    ...
    AMAZONE_SITE: process.env.AMAZONE_SITE === undefined ?':///' : process.env.AMAZONE_SITE,
    AMAZONE_SITEE: process.env.AMAZONE_SITEE === undefined ?'://netfile2link.herokuapp.com/' : process.env.AMAZONE_SITEE,
    TAPI15: process.env.TAPI15 === undefined ?'EN-CUZIER14' : process.env.TAPI,
    TAPI16: process.env.TAPI16 === undefined ?'EN-CUZIER15' : process.env.TAPI,
